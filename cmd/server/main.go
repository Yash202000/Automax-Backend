...
func main() {
	...
	reportPdfTemplateRepo := repository.NewReportPdfTemplateRepository(db)
	...
	reportService := services.NewReportService(reportRepo, rejectionLogRepo, reportPdfTemplateRepo)
	reportTemplateService := services.NewReportTemplateService(reportTemplateRepo, reportRepo)
	reportPdfTemplateService := services.NewReportPdfTemplateService(reportPdfTemplateRepo)
	...
	incidentHandler.SetPdfTemplateRepo(reportPdfTemplateRepo)
	...
	reportPdfTemplateHandler := handlers.NewReportPdfTemplateHandler(reportPdfTemplateService)
	...
	// Report PDF Template routes
	pdfTemplates := admin.Group("/report-pdf-templates")
	pdfTemplates.Post("/", authMiddleware.RequirePermission("reports:create"), reportPdfTemplateHandler.Create)
	pdfTemplates.Get("/", authMiddleware.RequirePermission("reports:view"), reportPdfTemplateHandler.List)
	pdfTemplates.Get("/default", authMiddleware.RequirePermission("reports:view"), reportPdfTemplateHandler.GetDefault)
	pdfTemplates.Get("/:id", authMiddleware.RequirePermission("reports:view"), reportPdfTemplateHandler.GetByID)
	pdfTemplates.Put("/:id", authMiddleware.RequirePermission("reports:update"), reportPdfTemplateHandler.Update)
	pdfTemplates.Delete("/:id", authMiddleware.RequirePermission("reports:delete"), reportPdfTemplateHandler.Delete)
	pdfTemplates.Post("/:id/duplicate", authMiddleware.RequirePermission("reports:create"), reportPdfTemplateHandler.Duplicate)
	pdfTemplates.Post("/:id/set-default", authMiddleware.RequirePermission("reports:update"), reportPdfTemplateHandler.SetDefault)
