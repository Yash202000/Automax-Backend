...
func main() {
	...
	reportService := services.NewReportService(reportRepo, rejectionLogRepo, locationRepo, classificationRepo)
	...
	ssoHandler := handlers.NewSSOHandler(ssoJWTManager, jwtManager, sessionStore, userRepo, applicationLinkRepo, userService, cfg.SSOFrontendURL)
