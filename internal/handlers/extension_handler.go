...
func NewExtensionHandler(service services.ExtensionService) *ExtensionHandler {
...
func (h *ExtensionHandler) clientCodeAllowed() bool {
	return strings.EqualFold(strings.TrimSpace(os.Getenv("CLIENT_CODE")), constants.CLIENT_CODE.EPM940)
}
